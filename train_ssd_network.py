...
tf.app.flags.DEFINE_float('gpu_memory_fraction', 0, 'GPU memory fraction to use.')
...
tf.app.flags.DEFINE_string(
    'dataset_dir', 'converted/', 'The directory where the dataset files are stored.')
tf.app.flags.DEFINE_integer(
    'labels_offset', 0,
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        dataset.data_sources='converted/*.tfrecord'
